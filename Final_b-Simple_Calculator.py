...
#Ian Hudson
#Simple Calculator with GUI: 02/21/2021 
#Derived from John Elder Codemy.com Python Tutorials
...
# Calculator icon attributed to:
https://www.flaticon.com/authors/pixel-perfect" title="Pixel perfect
root.iconbitmap(calc.ico)

# Create grid for GUI objects placement
e.grid(row=0, column=0, columnspan=3, padx=10, pady=10)

# 'Equal button', where all the calculating is done
def button_equal():
    second_number = e.get()
    e.delete(0, END)
    global f_num
